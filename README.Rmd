...
You can replace the default Font Awesome arrow icon ("fas fa-chevron-up") by [any other Font Awesome icon](https://fontawesome.com/icons?d=gallery), change its color, width and much more (run `?use_gotop()` to see the documentation).
