...
Add a "scroll back to top" Font Awesome icon to R Markdown documents and Shiny using [GoTop](https://scottdorman.blog/jquery-gotop/).
...
You can replace the default Font Awesome chevron up icon ("fas fa-chevron-up") by [any other Font Awesome icon](https://fontawesome.com/icons?d=gallery), change its color, width and much more (run `?use_gotop()` to see the documentation).
